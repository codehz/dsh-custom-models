// @ts-nocheck -- compatibility port from the upstream emitted adapter; behavior is covered by wire tests.
...
*/
var PiAiAdapter: {
  new (config: PiAiAdapterOptions): LlmAdapter & {

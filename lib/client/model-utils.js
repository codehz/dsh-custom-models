...
import { EFFORTS, THINKING_FORMATS, emptyCompat, emptyModel, } from "./types.js";
...
export function modelFromDiscovered(candidate) {
    return {
        ...emptyModel(),
        id: candidate.id,
        name: candidate.name ?? "",
...
export function adoptDiscoveredModels(models, candidates, picked) {
    const byId = new Map();

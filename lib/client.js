window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function modelFromDiscovered(candidate) {
			return {
				...emptyModel(),
				id: candidate.id,
				name: candidate.name ?? "",
				contextWindow: candidate.contextWindow === void 0 ? "" : formatCapacity(candidate.contextWindow),
				maxTokens: candidate.maxTokens === void 0 ? "" : formatCapacity(candidate.maxTokens)
			};
		}
		/** Merge picked listing rows into the draft catalog, keeping existing edits. */
		function adoptDiscoveredModels(models, candidates, picked) {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: fetchBusy ? t("fetching") : t("fetchModels")
						})]
					}),
					...
					fetchError !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "cm-error",
						role: "alert",
						children: fetchError
					}) : null,
